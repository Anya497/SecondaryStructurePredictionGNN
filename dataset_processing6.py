...
class RNADataset(Dataset):
    ...
    def raw_file_names(self):
        return list(map(lambda x: "dataset_1091/in/" + x, os.listdir("./data6/raw/dataset_1091/in")))
                ...
                for j in range(i, size):
                    ...
                    if abs(i - j) >= 3:
                        ...
                        if (n1 == 32 and n2 == 128) or (n1 == 128 and n2 == 32):
                            if in_im[i][j] == 255:
                                x.append([1, 0, 0, 1, 0, abs(i - j), [i, j]]) 
                            else:
                                x.append([1, 0, 0, 0, 1, abs(i - j), [i, j]]) 
...
#                                 y.append(0)
                        # CG
                            ...
                            if in_im[i][j] == 255:
                                x.append([0, 1, 0, 1, 0, abs(i - j), [i, j]]) 
                            else:
                                x.append([0, 1, 0, 0, 1, abs(i - j), [i, j]]) 
...
#                                 y.append(0)
                        # UG
                            ...
                            if in_im[i][j] == 255:
                                x.append([0, 0, 1, 1, 0, abs(i - j), [i, j]]) 
                            else:
                                x.append([0, 0, 1, 0, 1, abs(i - j), [i, j]]) 
...
#                                 y.append(0)
                    if j - i == 1:
                        x.append([0, 0, 0, 0, 0, abs(i - j), [i, j]])
                        y.append(-1)
